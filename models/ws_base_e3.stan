...
data {
  ...
  vector[N] Z_1_disc_8;
  vector[N] Z_1_disc_9;
  vector[N] Z_1_disc_10;
  vector[N] Z_1_disc_11;
  vector[N] Z_1_disc_12;
...
transformed parameters {
  ...
  vector[N_1] r_1_5;
  vector[N_1] r_1_6;
  vector[N_1] r_1_disc_7;
  vector[N_1] r_1_disc_8;
  vector[N_1] r_1_disc_9;
  vector[N_1] r_1_disc_10;
  vector[N_1] r_1_disc_11;
  vector[N_1] r_1_disc_12;
...
model {
  ...
  if (!prior_only) {
    ...
    for (n in 1:N) {
      // add more terms to the linear predictor
      disc[n] += r_1_disc_7[J_1[n]] * Z_1_disc_7[n] + r_1_disc_8[J_1[n]] * Z_1_disc_8[n] + r_1_disc_9[J_1[n]] * Z_1_disc_9[n] + r_1_disc_10[J_1[n]] * Z_1_disc_10[n] + r_1_disc_11[J_1[n]] * Z_1_disc_11[n] + r_1_disc_12[J_1[n]] * Z_1_disc_12[n];
    }
    for (n in 1:N) {
